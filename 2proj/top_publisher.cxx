...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        top.update();
        datawriter_qos.ownership_strength.value = instance->cpuUsage * 1000;

        printf("Writing TopFunction, #%d\n", count);

        /* Modify the data to be sent here */
        strcpy(instance->username, top.get_username());
        strcpy(instance->hostname, top.get_hostname()); 
        strcpy(instance->currentTime, top.get_currentTime()); 
        instance->cpuUsage = top.get_cpuUsage();
        instance->memUsage = top.get_memUsage();
        instance->procNumber = top.get_procNumber();
